...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="redpacket:redpacket:edit">
        <li><a href="${ctx}/redpacket/redpacket/form">优惠卷管理添加</a></li>
    </shiro:hasPermission>
</ul>
<form:form id="searchForm" modelAttribute="redpacket" action="${ctx}/redpacket/redpacket/" method="post"
    ...
    <ul class="ul-form">
        ...
        <li><label>优惠卷状态：</label>
            <form:select path="status" class="input-medium">
                ...
                <form:options items="${fns:getDictList('redpacket_status')}" itemLabel="label" itemValue="value"
                              htmlEscape="false"/>
            </form:select>
        </li>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="redpacket">
        <tr>
            ...
            <td>
                <c:if test="${redpacket.redpacketPrice!=null}">
                    ${redpacket.redpacketPrice/100}元
                </c:if>
            </td>
            <td>
            ...
            <shiro:hasPermission name="redpacket:redpacket:edit">
                <td>
                    ...
                    <a href="${ctx}/redpacket/redpacket/delete?id=${redpacket.id}"
                       onclick="return confirmx('确认要删除该优惠卷管理吗？', this.href)">删除</a>
                </td>
            </shiro:hasPermission>
        </tr>
    </c:forEach>
