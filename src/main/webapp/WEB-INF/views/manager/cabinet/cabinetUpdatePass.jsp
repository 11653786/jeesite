...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/cabinet/cabinet/updatePassword?id=${cabinet.id}">设置密码</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cabinet" action="${ctx}/cabinet/cabinet/updatePassword" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="foodPassword" htmlEscape="false" maxlength="255" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
