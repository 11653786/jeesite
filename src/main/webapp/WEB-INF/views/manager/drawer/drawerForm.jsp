...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/drawer/drawer/form?id=${drawer.id}">抽屉管理<shiro:hasPermission name="drawer:drawer:edit">${not empty drawer.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="drawer:drawer:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="drawer" action="${ctx}/drawer/drawer/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">抽屉状态：</label>
			<div class="controls">
				<form:select path="drawerStatus" class="input-xlarge required">
					<form:option value="" label=""/>
					<form:options items="${fns:getDictList('drawer_status')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">放餐状态：</label>
			<div class="controls">
				<form:select path="foodStatus" class="input-xlarge required">
					<form:option value="" label=""/>
