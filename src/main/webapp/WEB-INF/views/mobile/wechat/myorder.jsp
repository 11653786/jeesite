    ...
    <div style="margin-top:5px;margin-left:5px;" class="container no-bottom">
        <div class="section-title">
            ...
            <c:if test="${order.orderStatus==1}">
                <a  style="color:#000000;" href="${pageContext.request.contextPath}/api/wechat/refundOrder?type=1&orderNo=${order.orderNo}">评价</a>
                <a style="color:#000000;" href="${pageContext.request.contextPath}/api/wechat/refundOrder?type=2&orderNo=${order.orderNo}">问题反馈</a>
            </c:if>
